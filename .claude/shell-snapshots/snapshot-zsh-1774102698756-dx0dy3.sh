...
if ! (unalias rg 2>/dev/null; command -v rg) >/dev/null 2>&1; then
  ...
  if [[ -n $ZSH_VERSION ]]; then
    ARGV0=rg /Users/masanao/.local/share/claude/versions/2.1.81 "$@"
  elif [[ "$OSTYPE" == "msys" ]] || [[ "$OSTYPE" == "cygwin" ]] || [[ "$OSTYPE" == "win32" ]]; then
    ARGV0=rg /Users/masanao/.local/share/claude/versions/2.1.81 "$@"
  elif [[ $BASHPID != $$ ]]; then
    exec -a rg /Users/masanao/.local/share/claude/versions/2.1.81 "$@"
  else
    (exec -a rg /Users/masanao/.local/share/claude/versions/2.1.81 "$@")
  fi
}
fi
export PATH=/Users/masanao/.sdkman/candidates/sbt/current/bin\:/Users/masanao/.sdkman/candidates/java/current/bin\:/Users/masanao/.local/bin\:/Users/masanao/.bun/bin\:/Users/masanao/.local/state/fnm_multishells/78798_1774102613675/bin\:/usr/local/opt/mysql/bin\:/opt/homebrew/bin\:/opt/homebrew/sbin\:/usr/local/bin\:/System/Cryptexes/App/usr/bin\:/usr/bin\:/bin\:/usr/sbin\:/sbin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/local/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/appleinternal/bin\:/opt/pmk/env/global/bin\:/Library/Apple/usr/bin\:/Users/masanao/.orbstack/bin\:/opt/homebrew/opt/fzf/bin
